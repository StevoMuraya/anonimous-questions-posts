<aside
    ...
    <div class="collapse navbar-collapse" id="sidenav-collapse-main" style="height: initial;">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link @if ($active == 'pending')
                active bg-primary 
                @endif text-white" href="{{ route('home.index') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fas fa-question"></i>
                    </div>
                    <span class="nav-link-text ms-1">Questions Asked</span>
                </a>
            </li>
            <li class="nav-item">
    ...
    <div class="sidenav-footer position-absolute w-100 bottom-0 ">
        <div class="mx-3">
            <form action="{{ route('logout') }}" method="post" class="form-action">
                @csrf
                <button class="btn bg-gradient-danger mt-4 w-100">
